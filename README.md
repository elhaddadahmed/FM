...
- `script.js` — die komplette App-Logik (inkl. Biometrie-Sperre, 2FA/TOTP, Login-Historie, Auto-Logout)
...
## Wichtiger Hinweis zu Open Banking

Diese Version enthält noch **keine** automatische Bank-Anbindung (z. B. über GoCardless/FinTS) — das erfordert eine serverseitige Komponente (Supabase Edge Functions), da Bank-Zugriffstoken niemals im Browser-Code liegen dürfen. Weiterhin verfügbar ist der manuelle CSV-Kontoauszug-Import (Konten-Tab → "Kontoauszug importieren"), der Sparkasse-, Volksbank/VR- und Revolut-Exporte automatisch erkennt.
