...
function renderLogin(){
  root.innerHTML = `
    <div class="login-wrap">
      <div class="login-brand"><img src="./icons/logo.svg" class="brand-logo" alt="FinanzManager Logo"> FinanzManager</div>
...
function openTotpEnrollModal(factor){
  ...
  bg.innerHTML = `
    <div class="modal">
      ...
      <div style="text-align:center; margin-bottom:14px;">
        <div id="totp-qr" style="width:180px;height:180px;border-radius:10px;background:#fff;padding:8px;margin:0 auto; display:flex; align-items:center; justify-content:center;"></div>
      </div>
  ...
  // factor.totp.qr_code ist bei Supabase rohes SVG-Markup (kein Bild-Link!).
  // Direkt in ein <img src="..."> gepackt bricht das HTML, weil das SVG
  // selbst Anführungszeichen enthält (genau der Bug aus dem Screenshot).
  // Falls Supabase stattdessen mal eine echte data:-URI liefert, funktioniert
  // auch das über denselben Container.
  const qrEl = bg.querySelector('#totp-qr');
  const qr = factor.totp.qr_code || '';
  qrEl.innerHTML = /^data:/.test(qr) ? `<img src="${qr}" style="width:100%;height:100%;"/>` : qr;
  ...
  root.innerHTML = `
    <div class="app-shell">
      ...
      <div class="sidebar" id="sidebar">
        <div class="sb-brand"><img src="./icons/logo.svg" class="brand-logo" alt="FinanzManager Logo"> FinanzManager</div>
...
function renderKonten(c){
  ...
  c.innerHTML = `
    <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:16px; gap:10px; flex-wrap:wrap;">
      ...
      <div style="display:flex; gap:10px;">
        ...
        <button class="btn btn-primary" id="btn-open-banking">🏦 Bank verbinden</button>
  ...
  document.getElementById('btn-open-banking').onclick = openOpenBankingModal;
